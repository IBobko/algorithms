...
Развёрнутые материалы сгруппированы по темам:

* [Архитектура и технические решения](architecture.md)
* [Качество кода и code review](code-quality.md)
* [Delivery и ответственность за результат](delivery.md)
* [Люди, лидерство и менеджерская роль](leadership.md)
* [Коммуникация с заказчиком и менеджментом](communication.md)
* [System Design](system-design.md)
* [Production и надёжность](reliability.md)
* [Тестирование](testing.md)
* [Поведенческие вопросы](behavioral.md)

## 1. [Архитектура и технические решения](architecture.md)

Типовые вопросы:

* [Как вы выбираете архитектуру?](architecture.md#architecture-selection)
* [Когда монолит лучше микросервисов?](architecture.md#monolith-vs-microservices)
* [Как понять, что архитектура не масштабируется?](architecture.md#scalability-limits)
* [Как вы принимаете спорное техническое решение?](architecture.md#controversial-technical-decision)
* [Как вы документируете архитектурные решения?](architecture.md#architecture-documentation)
* [Что такое technical debt и как его обнаружить?](technical-debt.md)
* [Как вы решаете, рефакторить сейчас или позже?](architecture.md#refactoring-timing)
* [Как вы оцениваете риски технического решения?](architecture.md#technical-risk-assessment)
...
## 2. [Качество кода и code review](code-quality.md)

Типовые вопросы:

* [Как вы проводите code review?](code-quality.md#code-review)
* [Что для вас означает плохой код?](code-quality.md#bad-code)
* [Когда можно отказаться от идеального решения ради дедлайна?](code-quality.md#deadline-compromise)
* [Как вы вводите стандарты разработки в команде?](code-quality.md#development-standards)
* [Что делать, если разработчик регулярно пишет слабый код?](code-quality.md#weak-code)
* [Как вы снижаете количество дефектов?](code-quality.md#defect-reduction)
* [Какие метрики качества кода вы используете?](code-quality.md#code-quality-metrics)
...
## 3. [Delivery и ответственность за результат](delivery.md)
...
## 4. [Люди и лидерство](leadership.md)
...
## 5. [Коммуникация с заказчиком и менеджментом](communication.md)
...
## 6. [System Design](system-design.md)
...
## 7. [Production и надёжность](reliability.md)
...
## 9. [Поведенческие вопросы](behavioral.md)
